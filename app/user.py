...
@router.message(F.text == 'Контакты/локация')
async def get_location(message: Message, state: FSMContext):
    await message.answer('Наш номер телефона: 8-910-367-05-64\n'
                         'Наш адрес: Г. Воронеж, улица 9 января, 78\n'
                          'Г. Старый Оскол, мкрн. Дубрава, 3')
